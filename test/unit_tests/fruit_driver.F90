program tests
  ...
  ! test_gash.F90
  ! test_kiss.F90
  ! test_luxury_random_number_generator.F90
  ! test_timer.F90
  ...
  use test__gash
  use test_kiss
  use test_luxury_random_number_generator
  use test_timer
  ...
  ! test_luxury_random_number_generator.F90:
  call run_test_case(test_luxury_random_number_generator,"luxury_random_number_generator: test for expected values")
